...
module Wenmar
  class Client
    ...
    # Runs create_customers_store_credit (POST /customers/{customer_id}/store_credits).
    def create_customers_store_credit(customer_id, store_credit:)
      post("/customers/#{customer_id}/store_credits", {store_credit: store_credit})
    end
    ...
    # Runs create_store_credits_refund (POST /store_credits/{store_credit_id}/refunds).
    def create_store_credits_refund(store_credit_id, refund:)
      post("/store_credits/#{store_credit_id}/refunds", {refund: refund})
    end
    ...
    # Lists list_customers_conversations resources (paginated).
    # @return [Wenmar::Paginator]
    def list_customers_conversations(customer_id)
      get("/customers/#{customer_id}/conversations")
    end

    # Fetches all customers_conversations, up to 1000 by default.
    # @return [Array<Hash>]
    def get_all_customers_conversations(customer_id)
      paginator_to_a(list_customers_conversations(customer_id), 1000)
    end
    ...
    # Lists list_customers_store_credits resources (paginated).
    # @return [Wenmar::Paginator]
    def list_customers_store_credits(customer_id)
      get("/customers/#{customer_id}/store_credits")
    end

    # Fetches all customers_store_credits, up to 1000 by default.
    # @return [Array<Hash>]
    def get_all_customers_store_credits(customer_id)
      paginator_to_a(list_customers_store_credits(customer_id), 1000)
    end
    ...
    # Fetches show_customers_store_credit.
    def show_customers_store_credit(customer_id, id)
