...
- **GET /account/driveon** -> 200: object{id,name,slug,location_type,currency,time_zone,country,address,city,state,postal_code,contact_email,created_at,updated_at,driveon_station_number,default_starting_float_cents,default_labor_tax_enabled,default_parts_tax_enabled,ar_reply_to_email,ar_default_cc_emails,ar_default_bcc_emails,oil_change_reminders_enabled,tire_swap_reminders_enabled,brake_inspection_reminders_enabled,battery_check_reminders_enabled,close_requirements,lead_source_requirements,url,app_url} | 403: error envelope
...
- **GET /appointments** ?per_page,q,scheduling_status -> 200: array of Appointment
...
- **POST /appointments/{id}/approvals** ?id -> 200: object{type,id,scheduling_status,appointment_type,appointment_source,intake_method,all_day,starts_at,ends_at,estimated_duration_minutes,customer_id,vehicle_id,service_advisor_id,work_order_id,driver_id,marketing_source_id,customer_name,customer_email,customer_phone,customer_concern,follow_up_reason,year,make,model,submodel,vin,license_plate,customer_confirmed,confirmation_sent_at,reminder_sent_at,customer_arrived_at,customer_initiated,rescheduled_from_id,messages_count,reschedules_count,display_name,url,app_url,created_at,updated_at,customer,vehicle,service_advisor,work_order,location,latest_reschedule_id,approve_url,reject_url,cancel_url,follow_up_url,work_order_url,reconcile_vehicle_url}
- **POST /appointments/{id}/cancellations** ?id -> 200: object{type,id,scheduling_status,appointment_type,appointment_source,intake_method,all_day,starts_at,ends_at,estimated_duration_minutes,customer_id,vehicle_id,service_advisor_id,work_order_id,driver_id,marketing_source_id,customer_name,customer_email,customer_phone,customer_concern,follow_up_reason,year,make,model,submodel,vin,license_plate,customer_confirmed,confirmation_sent_at,reminder_sent_at,customer_arrived_at,customer_initiated,rescheduled_from_id,messages_count,reschedules_count,display_name,url,app_url,created_at,updated_at,customer,vehicle,service_advisor,work_order,location,latest_reschedule_id,approve_url,reject_url,cancel_url,follow_up_url,work_order_url,reconcile_vehicle_url}
- **POST /appointments/{id}/follow_ups** ?id -> 201: object{type,id,scheduling_status,appointment_type,appointment_source,intake_method,all_day,starts_at,ends_at,estimated_duration_minutes,customer_id,vehicle_id,service_advisor_id,work_order_id,driver_id,marketing_source_id,customer_name,customer_email,customer_phone,customer_concern,follow_up_reason,year,make,model,submodel,vin,license_plate,customer_confirmed,confirmation_sent_at,reminder_sent_at,customer_arrived_at,customer_initiated,rescheduled_from_id,messages_count,reschedules_count,display_name,url,app_url,created_at,updated_at,customer,vehicle,service_advisor,work_order,location,latest_reschedule_id,approve_url,reject_url,cancel_url,follow_up_url}
- **POST /appointments/{id}/rejections** ?id -> 200: object{type,id,scheduling_status,appointment_type,appointment_source,intake_method,all_day,starts_at,ends_at,estimated_duration_minutes,customer_id,vehicle_id,service_advisor_id,work_order_id,driver_id,marketing_source_id,customer_name,customer_email,customer_phone,customer_concern,follow_up_reason,year,make,model,submodel,vin,license_plate,customer_confirmed,confirmation_sent_at,reminder_sent_at,customer_arrived_at,customer_initiated,rescheduled_from_id,messages_count,reschedules_count,display_name,url,app_url,created_at,updated_at,customer,vehicle,service_advisor,work_order,location,latest_reschedule_id,approve_url,reject_url,cancel_url,follow_up_url,work_order_url,reconcile_vehicle_url}
- **POST /appointments/{id}/vehicle_reconciliations** ?id -> 200: object{type,id,scheduling_status,appointment_type,appointment_source,intake_method,all_day,starts_at,ends_at,estimated_duration_minutes,customer_id,vehicle_id,service_advisor_id,work_order_id,driver_id,marketing_source_id,customer_name,customer_email,customer_phone,customer_concern,follow_up_reason,year,make,model,submodel,vin,license_plate,customer_confirmed,confirmation_sent_at,reminder_sent_at,customer_arrived_at,customer_initiated,rescheduled_from_id,messages_count,reschedules_count,display_name,url,app_url,created_at,updated_at,customer,vehicle,service_advisor,work_order,location,latest_reschedule_id,approve_url,reject_url,cancel_url,follow_up_url,work_order_url}
...
- **POST /counter_sales/{counter_sale_id}/payments** ?counter_sale_id -> 200: object{id,counter_sale_number,sale_status,walk_in_name,notes,subtotal_cents,tax_total_cents,total_cents,paid_cents,remaining_cents,paid,currency,line_items_count,processed_by,location,created_at,updated_at,url,app_url,reopen_url}
- **GET /counter_sales/{id}** ?id -> 200: CounterSale
- **PATCH /counter_sales/{id}** ?id -> 200: CounterSale
- **PATCH /counter_sales/{id}/reopen** ?id -> 200: object{id,counter_sale_number,sale_status,walk_in_name,notes,subtotal_cents,tax_total_cents,total_cents,paid_cents,remaining_cents,paid,currency,line_items_count,processed_by,location,created_at,updated_at,url,app_url,reopen_url} | 403: error envelope | 422: error envelope

## Current Location

- **GET /current_location** -> 200: object{id,name,slug,location_type,currency,time_zone,country,address,city,state,postal_code,contact_email,created_at,updated_at,phones,dock,url,app_url}
- **PATCH /current_location** -> 200: object{id,name,slug,location_type,currency,time_zone,country,address,city,state,postal_code,contact_email,created_at,updated_at,phones,dock,url,app_url} | 403: error envelope
...
- **GET /customers/{customer_id}/conversations** ?customer_id -> 200: array of Conversation
...
- **GET /customers/{customer_id}/store_credits** ?customer_id -> 200: array of StoreCredit | 404: error envelope
- **POST /customers/{customer_id}/store_credits** ?customer_id -> 201: StoreCredit | 403: error envelope | 422: error envelope
- **GET /customers/{customer_id}/store_credits/{id}** ?customer_id,id -> 200: StoreCredit
...
- **GET /locations/{location_id}/close_requirements** ?location_id -> 200: object{id,name,slug,location_type,currency,time_zone,country,address,city,state,postal_code,contact_email,created_at,updated_at,driveon_station_number,default_starting_float_cents,default_labor_tax_enabled,default_parts_tax_enabled,ar_reply_to_email,ar_default_cc_emails,ar_default_bcc_emails,oil_change_reminders_enabled,tire_swap_reminders_enabled,brake_inspection_reminders_enabled,battery_check_reminders_enabled,close_requirements,lead_source_requirements,url,app_url} | 403: error envelope
- **PATCH /locations/{location_id}/close_requirements** ?location_id -> 200: object{id,name,slug,location_type,currency,time_zone,country,address,city,state,postal_code,contact_email,created_at,updated_at,driveon_station_number,default_starting_float_cents,default_labor_tax_enabled,default_parts_tax_enabled,ar_reply_to_email,ar_default_cc_emails,ar_default_bcc_emails,oil_change_reminders_enabled,tire_swap_reminders_enabled,brake_inspection_reminders_enabled,battery_check_reminders_enabled,close_requirements,lead_source_requirements,url,app_url}
...
- **GET /locations/{location_id}/lead_source_requirements** ?location_id -> 200: object{id,name,slug,location_type,currency,time_zone,country,address,city,state,postal_code,contact_email,created_at,updated_at,driveon_station_number,default_starting_float_cents,default_labor_tax_enabled,default_parts_tax_enabled,ar_reply_to_email,ar_default_cc_emails,ar_default_bcc_emails,oil_change_reminders_enabled,tire_swap_reminders_enabled,brake_inspection_reminders_enabled,battery_check_reminders_enabled,close_requirements,lead_source_requirements,url,app_url} | 403: error envelope
- **PATCH /locations/{location_id}/lead_source_requirements** ?location_id -> 200: object{id,name,slug,location_type,currency,time_zone,country,address,city,state,postal_code,contact_email,created_at,updated_at,driveon_station_number,default_starting_float_cents,default_labor_tax_enabled,default_parts_tax_enabled,ar_reply_to_email,ar_default_cc_emails,ar_default_bcc_emails,oil_change_reminders_enabled,tire_swap_reminders_enabled,brake_inspection_reminders_enabled,battery_check_reminders_enabled,close_requirements,lead_source_requirements,url,app_url}
- **GET /locations/{location_id}/reminders** ?location_id -> 200: object{id,name,slug,location_type,currency,time_zone,country,address,city,state,postal_code,contact_email,created_at,updated_at,driveon_station_number,default_starting_float_cents,default_labor_tax_enabled,default_parts_tax_enabled,ar_reply_to_email,ar_default_cc_emails,ar_default_bcc_emails,oil_change_reminders_enabled,tire_swap_reminders_enabled,brake_inspection_reminders_enabled,battery_check_reminders_enabled,close_requirements,lead_source_requirements,url,app_url} | 403: error envelope
- **PATCH /locations/{location_id}/reminders** ?location_id -> 200: object{id,name,slug,location_type,currency,time_zone,country,address,city,state,postal_code,contact_email,created_at,updated_at,driveon_station_number,default_starting_float_cents,default_labor_tax_enabled,default_parts_tax_enabled,ar_reply_to_email,ar_default_cc_emails,ar_default_bcc_emails,oil_change_reminders_enabled,tire_swap_reminders_enabled,brake_inspection_reminders_enabled,battery_check_reminders_enabled,close_requirements,lead_source_requirements,url,app_url}
...
- **POST /parts** -> 201: object{id,part_number,description,brand,part_type,barcode,stocked,cost_cents,sell_cents,taxable,vendor,vendor_id,core_charge_cents,on_hand,reorder_point,bin_location,created_at,updated_at,url,app_url} | 403: error envelope | 422: error envelope
- **DELETE /parts/{id}** ?id -> no content
- **GET /parts/{id}** ?id -> 200: object{id,part_number,description,brand,part_type,barcode,stocked,cost_cents,sell_cents,taxable,vendor,vendor_id,core_charge_cents,on_hand,reorder_point,bin_location,created_at,updated_at,url,app_url} | no content | 404: error envelope
- **PATCH /parts/{id}** ?id -> 200: object{id,part_number,description,brand,part_type,barcode,stocked,cost_cents,sell_cents,taxable,vendor,vendor_id,core_charge_cents,on_hand,reorder_point,bin_location,created_at,updated_at,url,app_url}
...
- **GET /reports/statements** ?filter[billing_status] -> 200: array of object | 403: error envelope
...
- **GET /reports/tax_periods** -> 200: array of object | 403: error envelope
- **POST /reports/tax_periods** -> 201: object{id,period_start,period_end,totals,marked_remitted,remitted_date,tax_jurisdiction,notes,created_at,updated_at,location,url,app_url} | 422: error envelope
- **PATCH /reports/tax_periods/{id}** ?id -> 200: object{id,period_start,period_end,totals,marked_remitted,remitted_date,tax_jurisdiction,notes,created_at,updated_at,location,url,app_url}
...
- **POST /store_credits/{store_credit_id}/refunds** ?store_credit_id -> 201: object{id,amount_cents,currency,method,processor_status,is_refund,is_adjustment,voided,voided_at,processed_at,reference,notes,created_at,updated_at,customer_id,url,app_url,customer,processed_by,location} | 422: error envelope
- **POST /store_credits/{store_credit_id}/voids** ?store_credit_id -> 200: StoreCredit | 403: error envelope | 422: error envelope
...
- **GET /work_orders/{work_order_id}/services** ?work_order_id -> 200: array of object
...
- **CreateCustomersStoreCreditRequest**: {store_credit*:object{kind,amount}}
...
- **CreateStoreCreditsRefundRequest**: {refund*:object{amount,method}}
...
- **Location**: {id*:integer, name*:string, slug*:string, location_type*:string, currency*:string, time_zone*:string, country*:string, address*:string, city*:string, state*:string, postal_code*:string, contact_email*:any, created_at*:string, updated_at*:string, phones*:array of any, dock*:array of object, url*:string, app_url*:string}
...
- **Statement**: {id*:integer, statement_number*:string, billing_status*:string, statement_date*:string, start_date*:string, end_date*:string, due_date*:string, totals*:object{previous_balance_cents,new_charges_cents,payments_received_cents,credits_cents,balance_due_cents,currency}, sent_at*:string, viewed_at*:string, customer*:object{id,full_name,url}, created_at*:string, updated_at*:string, url*:string, app_url*:string}
- **StoreCredit**: {id*:integer, kind*:string, amount_cents*:integer, balance_cents*:integer, reason*:string, voided_at*:string, created_at*:string, updated_at*:string, voided_by*:any, issued_by*:object{id,name,url}, source_payment*:any, location*:object{id,name,url}, url*:string, app_url*:string, voids_url*:string}
