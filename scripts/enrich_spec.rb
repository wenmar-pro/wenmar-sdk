...
module EnrichSpec
  ...
  RESOURCE_SCHEMAS = {
    ...
    SUB_ACTION_IDS = {
      ...
      # Unified lifecycle transitions (pilot: Customer, Vehicle, Vendor).
      "patch /customers/{id}/trash"    => "trash_customer",
      "patch /customers/{id}/archive"  => "archive_customer",
      "patch /customers/{id}/restore"  => "restore_customer",
      "patch /vehicles/{id}/trash"     => "trash_vehicle",
      "patch /vehicles/{id}/archive"   => "archive_vehicle",
      "patch /vehicles/{id}/restore"   => "restore_vehicle",
      "patch /vendors/{id}/trash"      => "trash_vendor",
      "patch /vendors/{id}/archive"    => "archive_vendor",
      "patch /vendors/{id}/restore"    => "restore_vendor",
      # Unified lifecycle transitions (phase 2b1: ServiceCategory, Package,
      # LaborRate, Inspection).
      "patch /service_categories/{id}/trash"   => "trash_service_category",
      "patch /service_categories/{id}/archive"  => "archive_service_category",
      "patch /service_categories/{id}/restore"  => "restore_service_category",
      "patch /packages/{id}/trash"              => "trash_package",
      "patch /packages/{id}/archive"            => "archive_package",
      "patch /packages/{id}/restore"            => "restore_package",
      "patch /labor_rates/{id}/trash"           => "trash_labor_rate",
      "patch /labor_rates/{id}/archive"         => "archive_labor_rate",
      "patch /labor_rates/{id}/restore"         => "restore_labor_rate",
      "patch /inspections/{id}/trash"           => "trash_inspection",
      "patch /inspections/{id}/archive"         => "archive_inspection",
      "patch /inspections/{id}/restore"         => "restore_inspection",
      # Work-order lifecycle POST commands (2026-09-11 spec 4.1; verbs
      # normalized from legacy PATCH close_* names).
      "post /work_orders/{id}/start"                            => "start_work_order",
      "post /work_orders/{id}/complete"                         => "complete_work_order",
      "post /work_orders/{id}/close"                            => "close_work_order",
      "post /work_orders/{id}/void"                             => "void_work_order",
      "post /work_orders/{id}/decline"                          => "decline_work_order",
      "post /work_orders/{id}/reopen"                           => "reopen_work_order",
      "post /work_orders/{id}/send_estimate"                    => "send_work_order_estimate",
      "post /work_orders/{id}/send_reminder"                    => "send_work_order_reminder",
